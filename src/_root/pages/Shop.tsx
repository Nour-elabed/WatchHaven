  ...
  return (
    <>
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 pt-6 pb-16">
        ...
        <button
          onClick={() => navigate('/')}
          className="flex items-center gap-2 text-gray-500 hover:text-black transition-colors mb-5 group"
        >
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <main className="flex-1">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
              <div>
                <h1 className="text-3xl font-extrabold tracking-tight">The Collection</h1>
